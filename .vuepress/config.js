  ...
  themeConfig: {
    ...
    sidebar: {
      '/': [
        ...
        {
          title: 'Ответы по главам',
          children: [
            { title: 'Предисловие', path: '/answers_by_chapter/b-000.md' },
            { title: 'Введение', path: '/answers_by_chapter/b-001.md' },
            { title: 'Глава 1', path: '/answers_by_chapter/b-010.md' },
            { title: 'Глава 2', path: '/answers_by_chapter/b-020.md' },
            { title: 'Глава 3', path: '/answers_by_chapter/b-030.md' },
            { title: 'Глава 4', path: '/answers_by_chapter/b-040.md' },
            { title: 'Глава 5', path: '/answers_by_chapter/b-050.md' },
            { title: 'Глава 6', path: '/answers_by_chapter/b-060.md' },
            { title: 'Глава 7', path: '/answers_by_chapter/b-070.md' },
            { title: 'Глава 8', path: '/answers_by_chapter/b-080.md' },
            { title: 'Глава 9', path: '/answers_by_chapter/b-090.md' },
            { title: 'Глава 10', path: '/answers_by_chapter/b-100.md' },
            { title: 'Глава 11', path: '/answers_by_chapter/b-110.md' },
            { title: 'Глава 12', path: '/answers_by_chapter/b-120.md' },
            { title: 'Глава 13', path: '/answers_by_chapter/b-130.md' },
            { title: 'Глава 14', path: '/answers_by_chapter/b-140.md' },
            { title: 'Глава 15', path: '/answers_by_chapter/b-150.md' },
            { title: 'Глава 16', path: '/answers_by_chapter/b-160.md' },
            { title: 'Глава 17', path: '/answers_by_chapter/b-170.md' },
            { title: 'Глава 18', path: '/answers_by_chapter/b-180.md' },
            { title: 'Глава 19', path: '/answers_by_chapter/b-190.md' },
          ],
        },
        {
          title: 'Шлоки',
